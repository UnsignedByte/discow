...
def genmap(Discow, msg):
    if msg.author.id not in map_messages or not map_messages[msg.author.id]:
        ...
        yield from Discow.add_reaction(blankmapmsg, special_emojis["empty"][0])
        yield from Discow.add_reaction(blankmapmsg, "\U00002B06")
        yield from Discow.add_reaction(blankmapmsg, special_emojis["empty"][1])
        yield from Discow.add_reaction(blankmapmsg, special_emojis["empty"][2])
        yield from Discow.add_reaction(blankmapmsg, "\U000023EB")
        yield from Discow.add_reaction(blankmapmsg, special_emojis["empty"][3])
